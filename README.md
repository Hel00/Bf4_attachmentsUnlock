...
## Link:
`ld.lld -m i386pep -o main.exe main.o /path/to/kernel32.dll /path/to/user32.dll -O3 --gc-sections --strip-all --file-alignment=16 --section-alignment=16 --subsystem windows`
